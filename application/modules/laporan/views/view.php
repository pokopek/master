      ...
      <div class="modal-body">
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-3">
              <select name="role" class="form-control" id="role" onchange="inst()">
                <option>- pilih -</option>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <select name="nama_instansi" class="form-control" id="nama_instansi">
                <option>- pilih -</option>
                <?php 
                $instansi = $this->db->query("SELECT * FROM instansi")->result();
                foreach ($instansi as $instn) {
                  echo '<option value="'.$instn->id_instansi.'">'.$instn->nama_instansi.'</option>';
                }
                ?>
              </select>
            </div>
