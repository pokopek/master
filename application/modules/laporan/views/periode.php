    ...
    <div class="contentpanel">
      <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">Laporan Detail Periode</h4>
      ...
      <div class="row row-stat">
          ...
          <form action="<?=base_url('laporan/cetak_periode_pdf');?>" id="form" class="form-horizontal" target="_blank" method="POST">
