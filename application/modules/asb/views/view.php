        ...
        <div class="media">
            ...
            <div class="media-body">
                <ul class="breadcrumb">
                    ...
                    <li><a href="">Analisa standart Biaya</a></li>
                </ul>
                <h4>Analisa standart Biaya</h4>
            </div>
        </div><!-- media -->
    </div><!-- pageheader -->
    ...
    <div class="contentpanel">
      <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">Data asb 2022</h4>
            <p>Data asb 2022 yang  terdaftar.
                <a href="#" class="btn btn-info btn-sm btn-rounded pull-right" onclick="add()"><i class="fa fa-plus"></i> Tambah Data asb</a>
          ...
          <table id="table" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="10%" style="text-align:center">ID asb</th>
      ...
      <div class="modal-body">
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <!-- <div class="form-group row">
            <label class="col-sm-3 control-label">asb </label>
            <div class="col-md-5">
          ...
          <div class="form-group row">
            <label class="col-sm-3 control-label">ID asb</label>
            <div class="col-md-9">
  ...
  $(document).ready(function() {
   ...
   function add()
   {
      ...
      // alert("asd");
       ...
       $('.modal-title').text('Tambah asb'); // Set Title to Bootstrap modal title
   }
   ...
   function edit(id)
   {
       ...
       $.ajax({
           ...
           success: function(data)
           {
               ...
               $('.modal-title').text('Edit asb'); // Set title to Bootstrap modal title
