...
class Asb extends CI_Controller {

   var $data_ref = array('uri_controllers' => 'asb');

	public function __construct()
	{
		parent::__construct();
		$this->load->model('asb_model','asb');
	...
	public function ajax_list()
	{
		...
		$output = array(
						"draw" => $_POST['draw'],
						"recordsTotal" => $this->asb->count_all(),
						"recordsFiltered" => $this->asb->count_filtered(),
						"data" => $data,
				);
	...
	public function ajax_update()
	{
		...
		$this->asb->update(array('id' => $this->input->post('id')), $data);
		echo json_encode(array("status" => TRUE));
	}

	public function ajax_delete($id)
	{
		$this->asb->delete_by_id($id);
		echo json_encode(array("status" => TRUE));
	}
