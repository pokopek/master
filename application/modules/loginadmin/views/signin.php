            ...
            <div class="panel panel-signin">
                <div class="panel-body">
                    <div class="logo text-center">
                        <img src="<?=base_url('template/');?>images/keluarga3.jpg" alt="Chain Logo" width="100px">
                    </div>
                    <br />
                    <h4 class="text-center mb5">LOGIN ADMIN</h4>
                   
                    <div class="mb10"></div>
                    
                    <form action="<?=base_url('loginadmin/operator');?>" method="post">
                ...
                <div class="panel-footer">
                    <center>Powered By nusambatu 2022</center>
                </div><!-- panel-footer -->
            </div><!-- panel -->
